<template>
  <div
    class="editor-container container col-md-9 p-1 bg-white"
    id="main-content"
  >
      ...
      <div class="col-md-10 col-lg-10 col-sm-10 titileInput">
        <div class="input-group flex-nowrap">
          ...
          <div class="input-group-append">
            <button class="btn btn-secondary">添加副标题</button>
          </div>
        </div>
      </div>
    ...
    <form class="form row text-sm-left text-md-center other-set my-2">
      <div class="col-sm-12 col-md-10 col-lg-10 my-2 d-flex"></div>
      <div class="col-md-2">
